...
DS = xr.open_dataset('../../link/data/rectangle/data/kida.04/topo.nc')
da = -0.01 * DS['depth']
...
img = da.plot.pcolormesh( transform=proj, vmin=-6000., vmax = 6000.,
                          cmap=cmocean.cm.topo, add_colorbar=False ) #, levels=np.arange(-1.,30.1,1.) )
#fig.colorbar(img)

#cntr = da.plot.contour( transform=proj, levels=[-400.,], colors="black",
