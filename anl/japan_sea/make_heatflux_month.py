#!/usr/bin/env python
"""海面熱フラックス領域平均値の日別値から月別値の値を計算する（重みをUsui and Hiroseにならう）

Usage: make_heatflux_month.py
...
ds=xr.open_dataset('nc/japansea_all/heatflux_ave_day.nc')
...
dso.to_netcdf(path='heatflux_ave_month.nc',mode='w')
logger.info('OUTPUT: heatflux_ave_month.nc')
